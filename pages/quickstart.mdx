...
```javascript
const { x402Gate, PAYNODE_ROUTER_ADDRESS_SANDBOX, BASE_USDC_ADDRESS_SANDBOX } = require('@paynodelabs/sdk-js');
...
// app.get('/api/data', x402Gate({ merchantAddress: '0x...', price: '1.00' }));
```

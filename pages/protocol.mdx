...
x-paynode-contract: 0x92e20164FC457a2aC35f53D06268168e6352b200
...
5. ✅ Is the token in the [accepted whitelist](/sdk-js#token-whitelist)?
...
### Fake Token Attacks
The `PayNodeVerifier` includes a built-in [Token Whitelist](/sdk-js#token-whitelist) that rejects non-approved ERC20 addresses — preventing attackers from deploying fake USDC contracts.

...
<Tabs items={['Usage', 'API Reference']}>
  <Tabs.Tab>
    ...
    ### 🚀 Recommended: Auto-Select (`requestGate`)

    The `PayNodeAgentClient` automatically handles the 402 handshake. It parses the merchant's `accepts` array and selects the best payment method (e.g., preferring EIP-3009 if available).
    ...
    ### Manual: EIP-3009 (`agent.signTransferWithAuthorization()`)
